...
Public Class mainForm
    ...
    Public BotMgr As BotManager
    Public SettingFile As String = Application.StartupPath & "\" & "botdata.xml"
    ...
    Private Sub mainForm_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        ...
        urlInput.Text = My.Settings.wsurl
    ...
    Private Sub OpenBtn_Click(sender As System.Object, e As System.EventArgs) Handles OpenBtn.Click
        ...
        If url <> "" Then
            ...
            websock.open(url)
        End If
        If BotMgr IsNot Nothing Then Exit Sub
        If My.Computer.FileSystem.FileExists(SettingFile) Then
            BotMgr = BotManager.Load(SettingFile)
        Else
            BotMgr = New BotManager
            BotMgr.Save(SettingFile)
        End If
        AddHandler BotMgr.SendMessage, AddressOf Send_Msg
        BotMgr.Init()
    End Sub
    Public Sub Send_Msg(msg As String)
        websock.send(msg)
    End Sub
    ...
    Private Sub websock_onopen() Handles websock.onopen
        ...
        websock.send("{""action"":""get_login_info"",""params"":{}}")
    ...
    Private Sub mainForm_Closing(sender As Object, e As CancelEventArgs) Handles Me.Closing
        ...
        My.Settings.wsurl = urlInput.Text
        My.Settings.Save()
    End Sub

    Private Sub ButtonSave_Click(sender As Object, e As EventArgs) Handles ButtonSave.Click
        If BotMgr IsNot Nothing Then
            BotMgr.Save(SettingFile)
        End If
    End Sub
    ...
    Private Sub ButtonLoad_Click(sender As Object, e As EventArgs) Handles ButtonLoad.Click
        If My.Computer.FileSystem.FileExists(SettingFile) Then
            If BotMgr IsNot Nothing Then RemoveHandler BotMgr.SendMessage, AddressOf Send_Msg
            BotMgr = BotManager.Load(SettingFile)
            AddHandler BotMgr.SendMessage, AddressOf Send_Msg
            BotMgr.Init()
        End If
